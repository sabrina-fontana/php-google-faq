    ...
    <header>
      <div class="header-top">
        <div class="header-top-left">
          <img src="img/googlelogo.svg" alt="">
      ...
      <?php
        $faqs = [
          ...
          [
            ...
            <p>You can learn more about safety and security online, including how to protect yourself and your family online, at the Google Safety Center.<br><br>
          ...
          [
            ...
            <ol><li>The Google affiliate that provides the services, that processes your information, and that is responsible for complying with applicable privacy laws. Generally, Google offers its consumer services through either of two companies:
              ...
              <div class=\"small-title\">Determining the country associated with your account</div>
